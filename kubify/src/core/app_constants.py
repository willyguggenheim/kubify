...
KUBIFY_LOCAL_DOMAIN = f"local.{KUBIFY_LOCAL_DOMAIN_SUFFIX}"  # The local domain (for development)
KUBIFY_UPSTREAM_DOMAIN_SUFFIX = os.environ.get("KUBIFY_UPSTREAM_DOMAIN_SUFFIX","kubify.com")   # The domain suffix for upstream environments (Example: <env>.kubify.local)

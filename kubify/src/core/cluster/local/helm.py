...
def install_chart(TILLER_HOST, name, type, location, dry_run=False, namespace="default"):
...
def deployment():
    ...
    builder = install_chart (api_version="3.2.4", name="test", version="0.1.0", app_version="v1",[deployment])
)
